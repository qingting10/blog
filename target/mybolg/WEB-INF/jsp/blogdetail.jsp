...
<div class="container" >
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <div class="page-header">
                <h1>
                    <small>${requestScope.get("blog").title}</small>
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 column">
            <a class="btn btn-success" href="${pageContext.request.contextPath}/blog/cancelStatus/${requestScope.get("blog").id}">撤销举报</a>
            <a class="btn btn-danger" href="${pageContext.request.contextPath}/blog/del/${requestScope.get("blog").id}">删除</a>
        </div>
    </div>

    <div class="row clearfix">
        <div class="col-md-12 column" style="margin-top: 20px">
            ${requestScope.get("blog").content}
        </div>
    </div>
</div>
